...
def user_input_features():
    ...
    nutrition_quality = st.number_input('Nutrición:', min_value=0, max_value=20, value=30, step=1)
    smokes = st.number_input('Fumar:', min_value=0, max_value=4, value=30, step=1)
